...
<head>
  ...
  if(isset($_POST['login'])){
    $sql = mysqli_query($con,"SELECT * FROM register WHERE username='$_POST[username]' and pass='$_POST[pass]'");
    $cek = mysqli_num_rows($sql);
    if ($cek>0){
      $_SESSION['username']=$_POST['username'];
      echo "<script>alert('Selamat datang');document.location.href='dashboard.php?menu=datadiri'</script>";
    }else{
  ...
  if(isset($_POST['register'])){
      echo "<script>alert('Isi pertanyaan yang sudah di tentukan');document.location.href='register.php'</script>";
    }
  ?>
              ...
              <div class="col-lg-6 d-none d-lg-block">               
                ...
                <div class="p-5">
                  ...
                  <form method="post" class="user">
                    ...
                    <p style="text-align:center;">if you haven't registered, click the register button</p>
                  </form>
                </div>
            </div>
          </div>
